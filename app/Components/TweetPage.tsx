...
const TweetPage = () => {
  ...
  <button onClick={showMoreTweets} className="absolute z-[99] bottom-[-30px] h-[70px] flex items-center justify-center w-[70px] left-[50%] px-4 py-2 rounded-[50%] bg-white text-black hover:text-white hover:bg-[#FF7B15] transition duration-300 -translate-x-[50%]" >
